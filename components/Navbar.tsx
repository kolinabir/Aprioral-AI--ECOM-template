...
export default function Navbar() {
  ...
  // Mock cart items
  const cartItems = [
    { id: 1, name: "Wireless Headphones", price: 129.99, quantity: 1, image: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=300&q=80" },
    { id: 2, name: "Smart Watch", price: 199.99, quantity: 2, image: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=300&q=80" },
  ];
  
  return (
    <>
      <nav className={`w-full bg-white fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'shadow-md py-3' : 'py-4'}`}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div className="hidden lg:flex items-center space-x-8">
                ...
                <Link href="/deals" className="text-gray-700 hover:text-primary transition-colors font-medium">
                  Deals
                </Link>
      ...
      {/* Cart Sidebar */}
      <div className={`fixed inset-0 bg-black/50 z-50 transition-opacity duration-300 ${isCartOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
           onClick={() => setIsCartOpen(false)}>
        <div 
          className={`absolute top-0 right-0 w-full max-w-md h-full bg-white shadow-xl transition-transform duration-300 overflow-auto ${isCartOpen ? 'translate-x-0' : 'translate-x-full'}`}
                    ...
                    <div key={item.id} className="flex items-center space-x-4 border-b pb-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex justify-between items-center mt-1">
                          ...
                          <button className="text-sm text-gray-500 hover:text-red-500">Remove</button>
                        </div>
                      </div>
                    </div>
                  ))}
